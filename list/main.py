...
def authenticate(request):
    if request.method != 'POST':
        r = '|ERROR| Request must be POST'
        print(r)
        return Response(r, status=401, mimetype='application/json')

    elif 'authorization' not in request.headers:
        r = '|ERROR| Request does not have auth token'
        print(r)
        ...
        "integrations": [
           {
               ...
               "form_url": "https://us-central1-aminton-sandbox-ps.cloudfunctions.net/tabby-action-form",
               "supported_action_types": ["dashboard"],
               "supported_download_settings": ["url"],
               "supported_formats": ["csv_zip"],
               "supported_formattings": ["unformatted"],
               "url": "https://us-central1-aminton-sandbox-ps.cloudfunctions.net/tabby-action-execute",
